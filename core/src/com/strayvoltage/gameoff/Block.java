...
public class Block extends GameMapObject {
  ...
  public void init(MapProperties mp, TextureAtlas textures)
  {
	...
	m_filterMask = Box2dVars.OBJECT| Box2dVars.BLOCK | Box2dVars.PLAYER_FOOT | Box2dVars.PLATFORM | Box2dVars.PLAYER_NORMAL | Box2dVars.PLAYER_JUMPING | Box2dVars.PLATFORM_STOP| Box2dVars.FLOOR;
    m_density = 1.5f;
    m_colBits = 3;
