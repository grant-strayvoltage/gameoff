...
public abstract class GameLayer implements GameContainer {
  ...
  {
    GameMain.getSingleton().setMusic2(musicName, v);
  }
  ...
  {
    GameMain.getSingleton().setMusic3(musicName, v);
  }

  public void setMusic2Volume(float volume)
  {
    GameMain.getSingleton().setMusic2Volume(volume);
  }

  public void setMusic3Volume(float volume)
  {
    GameMain.getSingleton().setMusic3Volume(volume);
  }
  ...
  {
    GameMain gm = GameMain.getSingleton();
    return gm.popGameLayer();
  }

  public void pushGameLayer(GameLayer newLayer)
  {
    GameMain gm = GameMain.getSingleton();
    gm.pushGameLayer(newLayer);
  }
  ...
  {
    return GameMain.getSingleton().m_assets;
  }
